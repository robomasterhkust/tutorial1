...
#define VAL_GPIOE_PUPDR             (PIN_PUPDR_FLOATING(GPIOE_PIN0) |       \
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOE_SPI4_MOSI) |       \
                                     PIN_PUPDR_PULLUP(GPIOE_LED_R) |       \
                                     PIN_PUPDR_FLOATING(GPIOE_PIN8) |       \
                                     PIN_PUPDR_FLOATING(GPIOE_PIN9) |       \
                                     PIN_PUPDR_FLOATING(GPIOE_PIN10) |     \
                                     PIN_PUPDR_FLOATING(GPIOE_PIN11) |      \
                                     PIN_PUPDR_PULLDOWN(GPIOE_SPI4_SCK) |      \
...
#define VAL_GPIOF_MODER             (PIN_MODE_ALTERNATE(GPIOF_I2C2_SDA) |           \
                                     ...
                                     PIN_MODE_INPUT(GPIOF_SPI5_IMU_SCK) |           \
                                     PIN_MODE_INPUT(GPIOF_SPI5_IMU_MISO) |           \
                                     PIN_MODE_INPUT(GPIOF_SPI5_IMU_MOSI) |           \
...
#define VAL_GPIOF_AFRL              (PIN_AFIO_AF(GPIOF_I2C2_SDA, 4U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOF_SPI5_IMU_SCK, 0U))
#define VAL_GPIOF_AFRH              (PIN_AFIO_AF(GPIOF_SPI5_IMU_MISO, 0U) |          \
                                     PIN_AFIO_AF(GPIOF_SPI5_IMU_MOSI, 0U) |          \
